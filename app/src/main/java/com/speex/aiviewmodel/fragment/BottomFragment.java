...
public class BottomFragment extends Fragment {
    ...
    private void init(View view) {
        ...
        //点击事件
        view.findViewById(R.id.bottom_frag_btn_post).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //在Activity中post事件到LiveData,LiveData将事件传递到注册观察他的各个组件
                mAccountModel.setAccount(new AccountBean("雪碧有点白", "136123456898", "www.baidu.com", "这是BottomFragment的消息"));
            }
        });
